...
var  page = {
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        appendStr+="<li class='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'>共 <span>100</span>页</li>";
        appendStr+="<li class='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'>共 <span>100</span>条</li>";
       return appendStr;
