...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
        ...
        if (data) {
          daysElement.forEach(function (v, i) {
            ...
            if (data[year + '-' + currentmonth + '-' + day]) {
			  ...
			  //v.addcontent=$('sc-mark').innerHTML('');
            } else {
      ...
      daysElement.forEach(function (v, i) {
        ...
        v.onclick = function () {
          ...
          this.classList.add('sc-selected');
	       ...
	       /* var divA = document.getElementByclassName("sc-selected");
			...
			div.id="div1"
			div.innerHTML = '<span>123111111</span>'
    ...
    value: function getSelectedDay() {
	 ...
	 // this.selectDay.querySelector('.day').css({"background":"red","color":"green"});
